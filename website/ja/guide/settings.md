...
| 連続した改行を保持 | 複数の空白行を折りたたまずにそのまま保持 | オン | オン/オフ |
...
| 閉じる時に未使用画像をクリーンアップ | ドキュメントで参照されなくなった画像をアセットフォルダーから自動的に削除。ドキュメント、ウィンドウ、アプリのいずれを閉じる時にも実行されます。同じフォルダー内の別のドキュメントがまだ参照している画像は保持され、削除された画像はシステムのゴミ箱に移動します | オフ | オン/オフ |
...
| 改行を折りたたむ | 3 つ以上の連続した改行を 2 つに削減 | オフ | オン/オフ |
