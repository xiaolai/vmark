...
| 保留連續換行 | 保留多個空白行，而非將其壓縮 | 開啟 | 開啟 / 關閉 |
...
| 關閉時清理未使用的圖片 | 自動從資產資料夾中刪除文件不再引用的圖片。關閉文件、視窗或應用程式時皆會執行。同一資料夾中其他文件仍在引用的圖片會保留，被移除的圖片會進入系統垃圾桶 | 關閉 | 開啟 / 關閉 |
