...
orientada a linhas; nesta versão você o escreve, ou a IA o faz, e é também o formato que um
gravador no aplicativo produziria quando esse recurso chegar), `inputs?` (um mapa
