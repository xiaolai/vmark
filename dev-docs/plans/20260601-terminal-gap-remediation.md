...
> Created: 2026-06-01
> Status: **Phases 1–3 complete** (branch `terminal-gap-remediation`); Phase 4
...
> - **Phase 3 (G3,G4, P2):** done (`screenReaderMode` + program-title shipped).
>   **Phase 4 (G6–G10 + coverage, P3):** not started.
