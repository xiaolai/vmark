...
- **Rev 6:** `pnpm test src/services/persistence/hotExit` is green; `cargo test --manifest-path src-tauri/Cargo.toml hot_exit` is green; v1 hot-exit sessions migrate to v2 with `formatId="markdown"` backfill in fixture tests.
