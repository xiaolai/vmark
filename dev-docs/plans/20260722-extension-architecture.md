...
| 4B markdown as extension | 🟡 **4 of 7** — WI-4.1 (partial), 4.2, 4.3, 4.6 done. Remaining: outline/word-count contribution (4.4), the markdown failure-open default (4.5), mermaid host dedup (4.7) |
