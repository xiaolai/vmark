...
| [011](ADR-011-plugin-manifest-contract.md) | Plugin manifest contract | Accepted (foundation) | 2026-05-24 |
| [012](ADR-012-command-bus-as-single-intent-path.md) | Command bus as single intent path | Accepted (foundation) | 2026-05-24 |
| [013](ADR-013-service-tier-as-cross-cutting-seam.md) | Service tier as cross-cutting seam | Accepted | 2026-05-24 |
| [014](ADR-014-theme-tokens-as-typed-data.md) | Theme tokens as typed data | Accepted (foundation) | 2026-05-24 |
