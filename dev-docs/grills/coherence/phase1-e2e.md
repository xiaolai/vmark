---
vmark:
  id: 019f7725-fb54-7e70-9595-41723f342c7b
---
...
## Session 3 follow-up (2026-07-19)

This record's ninth derivation edge (plan + spec → this file) was
established live in dogfood session 3 **through the shipping MCP funnel**
— a stdio MCP client driving the sidecar: both upstreams read in-session,
then this write captured with the session-observed inputs at `inferred`
confidence (spec §7 example 2). Closes the Session 2 reservation. This result is also the baseline for the Phase 3 provenance-recovery experiment specified in `design-3.md`.
