...
#[test]
fn duplicate_previous_window_labels_are_resurrected_only_once() {
    // The previous session is itself corrupt and contains two windows with
    // the same label. Resurrecting both would create a duplicate window on
