...
pub(crate) const MENU_ICONS: &[(&str, &str)] = &[
    ...
    ("last-used-tab", "arrow.uturn.backward"),
    ("split-documents", "square.split.2x1"),
    ("close-pane", "rectangle.badge.xmark"),
    ("focus-other-pane", "arrow.left.arrow.right"),
    ("sync-pane-scroll", "arrow.up.arrow.down"),
