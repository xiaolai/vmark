...
case "$PHASE" in
  ...
  5)
    ...
    run_script "WI-P5.4 sidecar query/style/execute_js" pnpm --dir server/mcp exec vitest run __tests__/unit/tools/browser.test.ts
  ...
  6)
    ...
    run_script "WI-P6.6 sidecar session + open profile" pnpm --dir server/mcp exec vitest run __tests__/unit/tools/browser.test.ts
