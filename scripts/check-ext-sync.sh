...
# parses supported_files.rs, calls getSupportedExtensions() at runtime, and asserts
...
echo "" >&2
echo "Rust source: src-tauri/src/supported_files.rs (SUPPORTED_EXTENSIONS const)" >&2
