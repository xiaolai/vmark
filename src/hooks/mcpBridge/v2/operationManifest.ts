 ...
 *   - server/mcp/src/bridge/core-types.ts   (wire request types)
 *   - src/hooks/mcpBridge/v2/dispatch.ts    (webview dispatcher cases)
 ...
 * @module hooks/mcpBridge/v2/operationManifest
 */
