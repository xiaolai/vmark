 ...
 * @module hooks/mcpBridge/v2/workspaceOpen
 */
 ...
 * Pane-aware: with a split enabled the focused pane owns the alias (ADR-1).
 */
function restoreBackgroundActivation(
  ...
  if (split.enabled) {
    usePaneStore.getState().setFocusedPaneTab(windowLabel, prevActiveTabId);
  } else {
