 ...
 *
 * @coordinates-with operationManifestParity.test.ts — the enforcement
 * @module services/mcpBridge/v2/__tests__/operationManifest
 */
...
export const BRIDGE_OPERATIONS = Object.freeze({
  ...
  "vmark.browser.workflow_status": { owner: "webview", effect: "read" },
  "vmark.browser.act": { owner: "webview", effect: "write" },
  "vmark.browser.workflow_run": { owner: "webview", effect: "write" },
  "vmark.browser.workflow_cancel": { owner: "webview", effect: "write" },
