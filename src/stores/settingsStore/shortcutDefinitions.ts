...
export const DEFAULT_SHORTCUTS: ShortcutDefinition[] = [
  ...
  { id: "bookmarkLink", label: "Bookmark", category: "formatting", defaultKey: "Alt-Mod-b", menuId: "bookmark", description: "Insert link to heading in document" },
  ...
  { id: "increaseHeading", label: "Increase Heading Level", category: "blocks", defaultKey: "Mod-Alt-]", menuId: "increase-heading" },
  { id: "decreaseHeading", label: "Decrease Heading Level", category: "blocks", defaultKey: "Mod-Alt-[", menuId: "decrease-heading" },
  ...
  { id: "findReplace", label: "Find and Replace", category: "navigation", defaultKey: "Mod-f", menuId: "find-replace" },
  ...
  { id: "windowStatus", label: "Window Status", category: "view", defaultKey: "Ctrl-Shift-5", menuId: "window-status", description: "Show/hide the Window Status panel — every open window's live Claude Code status" },
  ...
  { id: "showInvisibles", label: "Show Invisibles", category: "view", defaultKey: "F3", menuId: "show-invisibles", description: "Show or hide whitespace glyphs (·, →, ↓, ⏎)" },
  ...
  { id: "insertCollapsible", label: "Insert Collapsible Block", category: "blocks", defaultKey: "Alt-Mod-d", menuId: "collapsible-block" },
];
