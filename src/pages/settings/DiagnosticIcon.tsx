...
export function DiagnosticIcon({ status }: { status: DiagnosticStatus }) {
  switch (status) {
    ...
    // The file itself is the fault, so the glyph is a document rather than a
    // circle: error-toned like BinaryMissing, because both block the feature,
    // but visually distinct from it at a glance down the column.
