 ...
 *
 * @coordinates-with utils/markdownPipeline/__tests__/conformance/semanticProjection.ts
 * @module utils/markdownPipeline/__tests__/conformance/semanticProjection.test
 */
